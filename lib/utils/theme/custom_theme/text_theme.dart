...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 13.0,fontWeight: FontWeight.w500,color: Colors.black),
  ...
  headlineLarge: const TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.bold,color: Colors.white),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 1.0,fontWeight: FontWeight.normal,color: Colors.white.withOpacity(0.5)),
